...
class pyarchinit_US(QDialog):
    ...
    def __init__(self, iface):
        ...
        self.checkBox_query.stateChanged.connect(self.listview_us)
    ...
    def on_pushButton_fix_pressed(self):
        """
        Itera su tutti i record

        seleziona  una tupla della tableWidget rapporti

        richiama la funziona check_listoflist()
        per fissare l'errore
